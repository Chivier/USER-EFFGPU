...
const __device__ double CUDA_E1[] = {
...
const __device__ double CUDA_E2[] = {
...
const __device__ double CUDA_DE1[] = {
...
const __device__ double CUDA_DE2[] = {
...
__device__
void cuda_ElecNucElec(double q, double rc, double re1,
...
__device__
void cuda_ElecElecElec(double rc, double re1, double re2,
                         double *ecoul, double *frc, double *fre1,
                         double *fre2)
{
  double a, arc, re, fre;
...
__device__
void cuda_ElecCoreNuc(double q, double rc, double re1, double *ecoul, double *frc)
{
  double a, arc;
  double coeff_a;
  double E, dEdr, df, f;
...
__device__
void cuda_PauliElecElec(int samespin, double rc,
...
__device__
void cuda_RForce(double dx, double dy, double dz,
...
__device__
void cuda_SmallRForce(double dx, double dy, double dz,
...
__global__
void cuda_compute(int eflag, int vflag) {
