...
inline double cuda_ipoly02(double x)
{
...
inline double cuda_ipoly1(double x)
{
...
inline double cuda_ipoly01(double x)
{
  // P(x) in the range x < 2
...
inline double cuda_ierfoverx1(double x, double *df)
{
...
inline void cuda_KinElec(double radius, double *eke, double *frc)
{
...
inline void cuda_ElecNucNuc(double q, double rc, double *ecoul, double *frc)
{
  *ecoul += q / rc;
  *frc += q / (rc * rc);
}
...
inline void cuda_ElecNucElec(double q, double rc, double re1,
...
inline void cuda_ElecElecElec(double rc, double re1, double re2,
                         double *ecoul, double *frc, double *fre1,
                         double *fre2)
{
  double a, arc, re, fre;
...
inline void cuda_ElecCoreNuc(double q, double rc, double re1, double *ecoul, double *frc)
{
  double a, arc;
  double coeff_a;
  double E, dEdr, df, f;
...
inline void cuda_ElecCoreCore(double q, double rc, double re1, double re2,
...
inline void cuda_ElecCoreElec(double q, double rc, double re1, double re2,
...
inline void cuda_PauliElecElec(int samespin, double rc,
                          ...
                          double *frc, double *fre1, double *fre2)
{
  ...
  re1 *= CUDA_PAULI_RE; re2 *= CUDA_PAULI_RE; rc *= CUDA_PAULI_RC;
  ree = re1 * re1 + re2 * re2;
  rem = re1 * re1 - re2 * re2;
...
inline void cuda_PauliCoreElec(double rc, double re2, double *epauli, double *frc,
...
inline void cuda_PauliCorePElec(double rc, double re2, double *epauli, double *frc,
...
inline void cuda_RForce(double dx, double dy, double dz,
...
inline void cuda_SmallRForce(double dx, double dy, double dz,
...
inline double cuda_cutoff(double x)
{
...
inline double cuda_dcutoff(double x)
{
