  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    if (abs(spin[i]) == 1 || spin[i] == 2) {
      ...
      if (spin[i] == 2) {
        ...
        ElecNucElec(q[i], 0.0, eradius[i], &ecoul, &fpair, &e1rforce);
        ElecElecElec(0.0, eradius[i], eradius[i], &ecoul, &fpair, &e1rforce,
                     &e2rforce);

        // opposite spin electron interactions
        PauliElecElec(0, 0.0, eradius[i], eradius[i], &epauli, &s_fpair,
                      &e1rforce, &e2rforce);
    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      if (rsq < cutsq[itype][jtype]) {
        ...
        // electron (i) - electron (j) interactions
          ...
          ElecElecElec(rc, eradius[i], eradius[j], &ecoul, &fpair, &e1rforce,
                       &e2rforce);
          PauliElecElec(spin[i] == spin[j], rc, eradius[i], eradius[j], &epauli,
        ...
        // fixed-core (i) - electron (j) interactions
          ...
          ElecElecElec(rc, eradius[i], eradius[j], &ecoul, &fpair, &e1rforce,
                       &e2rforce);
          PauliElecElec(0, rc, eradius[i], eradius[j], &epauli, &s_fpair,
                        &s_e1rforce, &s_e2rforce);
          PauliElecElec(1, rc, eradius[i], eradius[j], &epauli, &s_fpair,
                        &s_e1rforce, &s_e2rforce);
        ...
        // electron (i) - fixed-core (j) interactions
          ...
          ElecElecElec(rc, eradius[j], eradius[i], &ecoul, &fpair, &e1rforce,
                       &e2rforce);
          ElecElecElec(rc, eradius[j], eradius[i], &ecoul, &fpair, &e1rforce,
                       &e2rforce);

          PauliElecElec(0, rc, eradius[j], eradius[i], &epauli, &s_fpair,
                        &s_e1rforce, &s_e2rforce);
          PauliElecElec(1, rc, eradius[j], eradius[i], &epauli, &s_fpair,
                        &s_e1rforce, &s_e2rforce);
        ...
        // pseudo-core (i) - electron/fixed-core electrons (j) interactions
          ...
          if (((PAULI_CORE_D[ecp_type[itype]]) == 0.0) &&
            ...
            if (abs(spin[j]) == 1) {
              ElecCoreElec(q[i], rc, eradius[i], eradius[j], &ecoul, &fpair,
                           &e2rforce);
        ...
        // electron/fixed-core electrons (i) - pseudo-core (j) interactions
          ...
          if (((PAULI_CORE_D[ecp_type[jtype]]) == 0.0) &&
            ...
            if (abs(spin[i]) == 1) {
              ElecCoreElec(q[j], rc, eradius[j], eradius[i], &ecoul, &fpair,
                           &e1rforce);
...
void PairEffCut::min_xf_pointers(int /*ignore*/, double **xextra,
                                 double **fextra) {
